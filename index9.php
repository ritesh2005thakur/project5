...
if(isset($_POST['register'])){
    ...
    $sql = "INSERT INTO form(question1) values ('$name')";
...
<div class="subscribe">
  <form action="#" method="POST">
    <div>
        <label><p>How much do you love me?</p></label>
      ...
      <div class="submit-btn"><a href="index8.php">NEXT</a>
      </div>
</div>
